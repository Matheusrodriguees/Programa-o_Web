...
case 'montar':
    ...
    while ($registro = mysqli_fetch_array($resultado)){
        echo "<tr>";
        echo "<td width='118'><font size='1' face='verdana, Arial, Helvetica, sans=serif'>Código<strong>:</strong></font></td>";
        echo "<td width='460'>";
...
case 'deletar':
    ...
    $sql="DELETE FROM users WHERE user_id='".$id."'";
        if(!mysqli_query($conexao,$sql)){
            ...
            echo"<script language='javascript'type='text/javascript'>
            alert('Dados exluidos com sucesso!')
            window.location.href='selecionar'</script>";
}
        mysqli_close($conn);
...
case 'selecionar':
        ...
        while($registro=mysqli_fetch_array($resultado)){
            ...
            echo"<td>".$mensagem."</td>";
            echo"<td><a href='crud.php?acao=deletar&id=$id'><img src='delete.png'alt='Deletar'title='Deletar registro'></
            a><a href='crud.php?acao=montar&id=$id'><img src='update.png'alt='Atualizar'title='Atualizar registro'></a><a
            href='index.php'><img src='insert.png'alt='Inserir'title='Inserir registro'></a>";
